...
class RegisterViewController: ScrollingFormViewController {
    ...
    override func setupView() {
        ...
        registerView.userNameInput.delegate = self
        registerView.emailInput.delegate    = self
        registerView.passwordInput.delegate = self
        registerView.confirmPasswordInput.delegate = self
    ...
    func registerAccount(){
     // do something
        ErrorReporting.showMessage(title: "", msg: "Berhasil Success")
    }
