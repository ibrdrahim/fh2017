...
class LoginViewController: ScrollingFormViewController,LoginPresenterView,GIDSignInUIDelegate {
    ...
    override func setupView() {
        ...
        loginView.userNameInput.delegate = self
...
//    }
    ...
    func setLoginError(errorMessage: String) {    
        ErrorReporting.showMessage(title: "Perhatian", msg: errorMessage)
    }
